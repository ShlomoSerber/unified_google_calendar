...
4. If the task is in phase 4 or 7, read `docs/04-fidelidad-visual.md` fully and check that `docs/design/tokens.json` has non-null tokens for the components the task needs. If not, run the `measure-component` skill first.
