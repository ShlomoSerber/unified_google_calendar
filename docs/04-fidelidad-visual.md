...
- 2026-09-16 — Transición ejecutada (M0 a M6): las mediciones viven en `docs/design/google/` y el pipeline (`scripts/measure/`, `tokens.json`, `measured.css`) se borró del repo. Nada de este documento se lee para implementar.
