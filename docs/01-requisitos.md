...
- 2026-09-16 (decisión del usuario en `99-decisiones.md`): R8.1 y R8.2 quedan derogados. La UI pasa a Material 3 con los componentes oficiales `@material/web` y ya no replica calendar.google.com; la especificación es `docs/11-material3.md` y el plan `docs/12-plan-m3.md`. R8.3 sigue vigente. R4.11 (tema claro u oscuro según el sistema) se cumple con los roles de color M3.
