...
- Sesión del 2026-09-17 (0.2.3): el usuario redujo la regla a tres botones (primario `md-filled-button`, secundario `md-text-button`, `md-icon-button`); `md-fab`, `md-outlined-button` y `md-assist-chip` ya no se registran. La etiqueta de la bandeja se reafirma cada minuto con un espacio de ancho cero alternado porque la extensión AppIndicator perdía la primera actualización (`99`, 2026-09-17).
